...
[[ -n "$PRIMARY_USER" ]] || PRIMARY_USER=$(basename "$(find /home -maxdepth 1 -type d 2>/dev/null | tail -1)")
...
chmod 750 /home/* 2>/dev/null || warn "home dir chmod skipped"
chmod 750 /home/*/Documents /home/*/Downloads /home/*/Desktop 2>/dev/null || warn "user dir chmod skipped"
